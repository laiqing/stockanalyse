...
def leanPush(ss):	
	...
	rdata = {}
	tday = time.strftime("%Y.%m.%d %H:%M",time.localtime())
	rdata["data"]={"alert":ss,"sound":"default","timestamp":tday}
	rdata["prod"]="dev"
